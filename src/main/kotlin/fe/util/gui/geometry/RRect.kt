...
import fe.util.gui.util.toStringAsFixed
...
data class RRect(
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("grow(delta)", "fe.util.gui.geometry.grow"),
    ...
    @Deprecated(
        "renamed to avoid conceptual naming collision with android inflate",
        replaceWith = ReplaceWith("shrink(delta)", "fe.util.gui.geometry.shrink"),
        level = DeprecationLevel.ERROR
    )
